...
from config import dutrgbdte_path
from network import HDFNet_VGG16
...
if __name__ == "__main__":
    proj_list = ["HDFNet_VGG16"]

    arg_dicts = {
        "HDFNet_VGG16": {"net": HDFNet_VGG16, "pth_path": None, "save_root": ""},  # 必须有
        "new_size": 320,
        "test_on_gpu": True,
    }

    data_dicts = {
        "dut-rgbd1": dutrgbdte_path,
        "dut-rgbd2": dutrgbdte_path,
        "dut-rgbd3": dutrgbdte_path,
        "dut-rgbd4": dutrgbdte_path,
    }
